...
public class AgentManager implements AgentManager1 {
    ...
    public void RegisterAgent(DBusPath dBusPath, String s) throws BluezInvalidArgumentsException, BluezAlreadyExistsException {
    ...
    public void UnregisterAgent(DBusPath dBusPath) throws BluezDoesNotExistException {
    ...
    public void RequestDefaultAgent(DBusPath dBusPath) throws BluezDoesNotExistException {
